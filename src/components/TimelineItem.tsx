...
import { Briefcase, Calendar, MapPin, ArrowRight, Quote, Sparkles } from 'lucide-react';
...
export const TimelineItem: React.FC<TimelineItemProps> = ({ experience, isLast }) => {
  ...
  return (
    <div className="relative flex gap-2.5 sm:gap-6 group">
      ...
      {/* Right Content Card with 3D Tilt */}
      <div className="grow pb-6 sm:pb-8 min-w-0">
        <Tilt3DCard maxTilt={4} className="w-full">
          <div className="glass-panel p-4 sm:p-6 relative overflow-hidden border-white/10 hover:border-cyan-500/40">
            ...
            <div className="p-2.5 sm:p-3 rounded-xl bg-slate-950/70 border-l-2 border-cyan-400 text-[11px] sm:text-xs text-slate-300 italic flex items-start gap-2">
