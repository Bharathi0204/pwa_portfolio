...
export const FloatingActionHub: React.FC<FloatingActionHubProps> = ({ onOpenAssistant }) => {
  ...
  return (
    ...
    >
      ...
      {/* Scroll to Top Floating Button - Smooth Scale Transition */}
      <button
        onClick={scrollToTop}
        aria-label="Back to top"
        title="Scroll to top of page"
        className={`pointer-events-auto p-3 rounded-2xl bg-slate-900/90 backdrop-blur-md border border-white/15 text-slate-300 hover:text-cyan-300 hover:border-cyan-500/40 shadow-xl shadow-black/40 transition-all duration-300 hover:scale-110 active:scale-95 group flex items-center justify-center ${
          showScrollTop
      ...
      <button
        ...
        className="pointer-events-auto p-3 sm:p-3.5 rounded-2xl bg-gradient-to-br from-violet-600 via-sky-600 to-cyan-500 text-white shadow-2xl shadow-violet-500/40 hover:shadow-cyan-500/40 hover:scale-105 active:scale-95 transition-all duration-200 group flex items-center gap-2 border border-white/25"
      >
