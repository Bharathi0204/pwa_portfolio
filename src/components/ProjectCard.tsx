    ...
    >
      <div className="glass-panel p-4 sm:p-6 flex flex-col justify-between group relative overflow-hidden h-full border-white/10 hover:border-cyan-500/50">
        ...
        <div>
          ...
          <h3 className="font-heading font-bold text-lg sm:text-2xl text-white group-hover:text-cyan-300 transition-colors flex items-center justify-between gap-2">
            ...
            <button 
              ...
              className="p-1.5 rounded-lg bg-white/5 group-hover:bg-cyan-500/20 text-slate-400 group-hover:text-cyan-300 transition-all shrink-0"
        ...
        <div>
          ...
          <button
            onClick={() => onOpenCaseStudy(project)}
            className="w-full py-2.5 rounded-xl bg-slate-900/90 hover:bg-cyan-950/60 border border-white/10 hover:border-cyan-500/40 text-cyan-300 text-xs font-bold flex items-center justify-center gap-2 transition-all shadow-sm group-hover:border-cyan-500/50"
          >
