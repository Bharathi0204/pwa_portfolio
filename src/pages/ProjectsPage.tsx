...
export const ProjectsPage: React.FC<ProjectsPageProps> = ({ onOpenCaseStudy }) => {
  ...
  return (
    <section id="projects" className="py-14 sm:py-20 relative">
      ...
      {/* Background glow */}
      <div className="glow-orb glow-orb-emerald w-[300px] sm:w-[450px] h-[300px] sm:h-[450px] top-40 right-0" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-5 sm:gap-6 mb-10 sm:mb-12">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 text-[11px] sm:text-xs font-mono font-bold uppercase tracking-wider mb-2.5 sm:mb-3">
        ...
        {selectedCategory === 'All' && (
          <div className="mb-8 sm:mb-10 rounded-2xl p-5 sm:p-8 bg-gradient-to-br from-slate-900 via-slate-900/90 to-emerald-950/40 border border-emerald-500/40 shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center">
              <div className="lg:col-span-8 space-y-3.5">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="px-2.5 py-0.5 rounded-full bg-amber-500/20 border border-amber-500/40 text-amber-300 text-[10px] sm:text-xs font-bold flex items-center gap-1.5">
                    ...
                    1st Prize — AI & Generative AI @ SRM Project Day (₹50k Award)
                  </span>
                  <span className="px-2 py-0.5 rounded-full bg-cyan-500/15 text-cyan-300 text-[10px] sm:text-[11px] font-mono">
                    IoT + FastAPI + 22 Indian Languages
                  </span>
                </div>

                <h3 className="font-heading font-black text-xl sm:text-3xl lg:text-4xl text-white">
              ...
              <div className="lg:col-span-4 flex flex-col justify-center space-y-2.5 sm:space-y-3">
                <div className="p-3 sm:p-4 rounded-xl bg-slate-950/80 border border-white/10 text-center">
                  ...
                  <div className="font-heading font-black text-xl sm:text-2xl text-emerald-400 mt-0.5">+45% Water Saved</div>
                </div>

                <button
                  onClick={() => onOpenCaseStudy(PROJECTS[0])}
                  className="w-full py-3 rounded-xl bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-400 hover:to-cyan-400 text-slate-950 font-bold text-xs sm:text-sm flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/20 transition-all"
                >
