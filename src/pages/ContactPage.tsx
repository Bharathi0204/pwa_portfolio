...
export const ContactPage: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-14 sm:py-20 relative">
      ...
      {/* Background glow */}
      <div className="glow-orb glow-orb-cyan w-[300px] sm:w-[400px] h-[300px] sm:h-[400px] bottom-10 left-10" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Section Header */}
        <div className="max-w-3xl mb-10 sm:mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/30 text-cyan-300 text-[11px] sm:text-xs font-mono font-bold uppercase tracking-wider mb-2.5 sm:mb-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
          ...
          <div className="lg:col-span-5 space-y-4 sm:space-y-6">
            ...
            <div className="glass-panel p-4 sm:p-6 space-y-3.5 sm:space-y-4">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="min-w-0">
                  <div className="text-[11px] sm:text-xs text-slate-400 font-mono">Email Address</div>
                  <a
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  <div className="text-[11px] sm:text-xs text-slate-400 font-mono">Current Location</div>
              ...
              <div className="pt-2 flex flex-wrap gap-2">
                <a
                  ...
                  className="flex-1 py-2.5 px-3 rounded-xl bg-slate-950 border border-white/10 hover:border-cyan-400 text-slate-300 hover:text-cyan-400 text-xs font-semibold flex items-center justify-center gap-1.5 transition-all"
                >
            ...
            <div className="p-3.5 sm:p-4 rounded-xl bg-slate-950/80 border border-white/10 text-xs text-slate-300 space-y-1.5">
              <div className="font-mono font-bold text-cyan-400 uppercase tracking-wide flex items-center gap-1.5 text-[11px]">
                <Sparkles className="w-3.5 h-3.5 shrink-0" />
                Professional Rule:
              </div>
              <p className="italic text-slate-400 text-[11px] sm:text-xs">
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-3.5 sm:space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4">
                    <div>
                      <label className="block text-[11px] sm:text-xs font-mono text-slate-400 mb-1">
                        Your Name *
                      </label>
                      <input
                        type="text"
