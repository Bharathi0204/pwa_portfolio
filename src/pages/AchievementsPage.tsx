...
export const AchievementsPage: React.FC = () => {
  ...
  return (
    <section id="achievements" className="py-14 sm:py-20 relative">
      ...
      {/* Background glow */}
      <div className="glow-orb glow-orb-cyan w-[300px] sm:w-[400px] h-[300px] sm:h-[400px] top-20 right-10" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Section Header */}
        <div className="max-w-3xl mb-10 sm:mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-300 text-[11px] sm:text-xs font-mono font-bold uppercase tracking-wider mb-2.5 sm:mb-3">
        ...
        <div 
          ...
          className="glass-panel p-5 sm:p-8 mb-8 sm:mb-10 border-amber-500/40 bg-gradient-to-r from-slate-950 via-slate-900 to-amber-950/30 shadow-2xl shadow-amber-500/10 cursor-pointer group relative overflow-hidden"
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6 items-center">
            <div className="lg:col-span-8 space-y-2.5 sm:space-y-3">
              ...
              <h3 className="font-heading font-black text-xl sm:text-2xl lg:text-3xl text-white group-hover:text-amber-300 transition-colors">
            ...
            <div className="lg:col-span-4 flex items-center justify-center lg:justify-end pt-2 lg:pt-0">
              <div className="w-20 h-20 sm:w-28 sm:h-28 rounded-2xl bg-gradient-to-br from-amber-400 to-orange-600 p-0.5 shadow-2xl shadow-amber-500/30 flex items-center justify-center group-hover:scale-105 transition-transform shrink-0">
                <div className="w-full h-full bg-slate-950 rounded-[14px] flex flex-col items-center justify-center text-center p-2">
                  <Trophy className="w-6 h-6 sm:w-8 sm:h-8 text-amber-400 mb-0.5 sm:mb-1 shrink-0" />
                  <span className="font-heading font-black text-[10px] sm:text-xs text-white">1ST PRIZE</span>
          ...
          {PERSONAL_INFO.education.map((edu, idx) => (
            ...
            >
              <div className="flex items-center justify-between gap-2 mb-2.5">
                ...
                <span className="text-[11px] sm:text-xs text-slate-400 font-mono">{edu.duration}</span>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
          {ACHIEVEMENTS.slice(2).map((item) => (
            <div
              key={item.id}
              className="p-4 sm:p-5 rounded-2xl bg-slate-950/70 border border-white/10 hover:border-cyan-500/30 transition-all flex items-start gap-3 sm:gap-4"
            >
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-slate-900 border border-white/10 text-cyan-400 flex items-center justify-center shrink-0">
