...
export const ExperiencePage: React.FC = () => {
  ...
  return (
    <section id="experience" className="py-14 sm:py-20 relative">
      ...
      {/* Background glow */}
      <div className="glow-orb glow-orb-cyan w-[300px] sm:w-[400px] h-[300px] sm:h-[400px] top-20 -left-20" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl mb-10 sm:mb-16">
          ...
          <p className="text-slate-300 text-xs sm:text-sm lg:text-base mt-2.5 sm:mt-3 leading-relaxed">
        ...
        <div className="glass-panel p-4 sm:p-6 mb-10 sm:mb-12 overflow-x-auto custom-scrollbar">
          <div className="text-[11px] sm:text-xs font-mono text-slate-400 uppercase tracking-wider mb-3 flex items-center gap-2">
            <Sparkles className="w-3.5 h-3.5 text-cyan-400 shrink-0" />
            <span>Technical Evolution Path</span>
          </div>

          <div className="flex items-center gap-2 sm:gap-4 min-w-[620px]">
            {careerPath.map((step, idx) => (
              <React.Fragment key={idx}>
                <div className="p-2.5 sm:p-3 rounded-xl bg-slate-950/80 border border-white/10 flex-1 hover:border-cyan-500/40 transition-all">
                  ...
                  <div className="text-[10px] sm:text-[11px] text-slate-400 mt-0.5">{step.label}</div>
                </div>
